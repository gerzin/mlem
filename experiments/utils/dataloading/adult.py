...
def load_adult_data(data_name="adult-blackbox-data.npz", data_folder_path=None):
    """
    Load the adult data dictionary in experiments/data/adult
    Args:
    ...
    if data_folder_path:
        ...
        adult_path = DEFAULT_ADULT_PATH

    return np.load(adult_path / data_name)


def load_adult_randomforest(data_name="adult_randfor.bz2", data_folder_path=None):
    """
